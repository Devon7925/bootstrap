...
impl<'a> Parser<'a> {
    ...
    fn current_binary_op(&self) -> Option<(BinaryOp, u8, bool)> {
        match self.current().kind {
            TokenKind::Star => Some((BinaryOp::Mul, 70, false)),
            TokenKind::Slash => Some((BinaryOp::Div, 70, false)),
            TokenKind::Percent => Some((BinaryOp::Rem, 70, false)),
            TokenKind::Plus => Some((BinaryOp::Add, 60, false)),
            TokenKind::Minus => Some((BinaryOp::Sub, 60, false)),
            TokenKind::ShiftLeft => Some((BinaryOp::Shl, 50, false)),
            TokenKind::ShiftRight => Some((BinaryOp::Shr, 50, false)),
            TokenKind::Ampersand => Some((BinaryOp::BitAnd, 45, false)),
            TokenKind::Caret => Some((BinaryOp::BitXor, 40, false)),
            TokenKind::Pipe => Some((BinaryOp::BitOr, 35, false)),
            TokenKind::LessThan => Some((BinaryOp::Lt, 30, false)),
            TokenKind::LessThanEqual => Some((BinaryOp::Le, 30, false)),
            TokenKind::GreaterThan => Some((BinaryOp::Gt, 30, false)),
            TokenKind::GreaterThanEqual => Some((BinaryOp::Ge, 30, false)),
            TokenKind::DoubleEquals => Some((BinaryOp::Eq, 25, false)),
            TokenKind::NotEquals => Some((BinaryOp::Ne, 25, false)),
            TokenKind::AndAnd => Some((BinaryOp::And, 20, false)),
            TokenKind::OrOr => Some((BinaryOp::Or, 10, false)),
            _ => None,
        }
    }
